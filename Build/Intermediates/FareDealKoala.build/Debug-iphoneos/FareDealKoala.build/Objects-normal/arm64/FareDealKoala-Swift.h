...
SWIFT_CLASS("_TtC13FareDealKoala11AppDelegate")
...
@property (nonatomic) NSString * __nonnull locationStatus;
...
SWIFT_CLASS("_TtC13FareDealKoala16SelectionOverlay")
@interface SelectionOverlay : OverlayView
...
SWIFT_CLASS("_TtC13FareDealKoala24TinderLikeViewController")
@interface TinderLikeViewController : UIViewController
@property (nonatomic, weak) IBOutlet KolodaView * __null_unspecified kolodaView;
- (void)viewDidLoad;
